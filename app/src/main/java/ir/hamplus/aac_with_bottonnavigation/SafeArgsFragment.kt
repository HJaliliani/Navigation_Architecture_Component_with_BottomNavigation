...
class SafeArgsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            //safe Args
           /* val args = ParamsFragmentArgs.fromBundle(it)
            param1 = args.param1
            param2 = args.param2*/
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_safe_args, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SafeArgsFragment.
         */
